...
}:
{
  ...
  fonts = {
    fontconfig = {
      ...
      defaultFonts = {
        serif = [
          config.fontconfig.serif
          config.fontconfig.cjkSerif
        ];
        sansSerif = [
          config.fontconfig.sans
          config.fontconfig.cjkSans
        ];
        monospace = [
          config.fontconfig.mono
          config.fontconfig.cjkMono
        ];
  ...
  xdg.configFile = {
    "fontconfig/conf.d/60-hm-aliases.conf".text =
      let
        sansAliases = [
          "-apple-system"
          "Helvetica"
